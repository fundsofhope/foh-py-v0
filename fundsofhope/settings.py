"""
Django settings for fundsofhope project.
...
SECRET_KEY = '7d!hequ)0g8*9_gsp%i@9!r7_o&!bg@gitm8-)90!d)%&5(o0h'
...
WSGI_APPLICATION = 'fundsofhope.wsgi.application'
